        ...
        <div>
            ...
            <div className='grid grid-cols-3 gap-4'>
                ...
                <div className='card w-96 bg-base-100 shadow-xl'>
                    <div class="card-body">
                        <h3 class="text-amber-900 font-bold text-xl">**How will you improve the performance of a React Application?</h3>
                ...
                <div className='card w-96 bg-base-100 shadow-xl'>
                    <div class="card-body">
                        <h3 class="text-amber-900 font-bold text-xl">**What are the different ways to manage a state in a React application?</h3>
                ...
                <div className='card w-96 bg-base-100 shadow-xl'>
                    <div class="card-body">
                        <h3 class="text-amber-900 font-bold text-xl">**How does prototypical inheritance work?</h3>
                ...
                <div className='card w-96 bg-base-100 shadow-xl'>
                    <div class="card-body">
                        <h3 class="text-amber-900 font-bold text-xl">**Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts?</h3>
                ...
                <div className='card w-96 bg-base-100 shadow-xl'>
                    <div class="card-body">
                        <h3 class="text-amber-900 font-bold text-xl">**What is a unit test? Why should write unit tests?</h3>
